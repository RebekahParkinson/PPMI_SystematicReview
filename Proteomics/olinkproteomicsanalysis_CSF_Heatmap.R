...
# CSF <- read.csv("/Volumes/PARK2023-Q5758/SAA Systematic Review (Human Data)/Becky/Code_Output/Proteomics_CSF_INF_Transposed.csv")
df <- read.csv("/Volumes/PARK2023-Q5758/SAA Systematic Review (Human Data)/Becky/Code_Output/Proteomics_pheno_CSF.csv")
# CSF <- read.csv("/Volumes/PARK2023-Q5758/SAA Systematic Review (Human Data)/Code_Output/CSFNPX_Transposed.csv")
df <- na.omit(df)
...
heatmap_colors <- colorRampPalette(c("#ff0000", "white", "#0000ff"))(100)
